...
class Flashcard(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, unique=True, default=generate_uuid)
...
class Studyset(Base):
    ...
    flashcards:Mapped[list[Flashcard]] = relationship("FlashcardStudySession", back_populates="study_session")
