from .models import Flashcard, Studyset, FlashcardStudySession, Difficulty
from sqlalchemy import inspect
from .db_connection import new_session
   
def create_flashcard(f_question, f_answer, studyset_name = None):
...
def add_to_studyset(flashcard, studyset):
